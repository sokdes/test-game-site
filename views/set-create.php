    	...
    	<div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sx-8 col-sm-8">
                ...
                <div class="content">
                    ...
                    <!-- $setsModel -->
                    <?php $form = ActiveForm::begin(['id' => 'set-create-form']); ?>

                    <?= $form->field($setsModel, 'name')->textInput() ?>
                    
                    
                    <?= $form->field($setsModel, 'image')->hiddenInput(['class'=>'uploadImageHiddenInput'])->label(false) ?>

                    <?= $form->field($setsModel, 'about')->textarea(['rows' => '6'])  ?>
                    <?= $form->field($setsModel, 'active')->checkbox(['label' => 'Показывать', 'labelOptions' => ['style' => 'padding-left:20px;'], 'checked' => 'checked']) ?>


                    <div class="form-group">
                        <div class="col-lg-6">
                            <?= Html::submitButton('Сохранить', ['class' => 'btn btn-primary', 'name' => 'set-button']) ?>
                        </div>
                        <div class="col-lg-6 text-right">
                            <?= Html::a('Отменить', 'sets', ['class' => 'btn btn-danger', 'name' => 'set-button-cansel']) ?>
                        </div>
