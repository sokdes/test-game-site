            ...
            <div class="col-lg-8 col-md-8 col-sx-8 col-sm-8">
                ...
                <div class="content">
                    ...
                    <div class="row mb_2 mt_3">
                        <div class="col-lg-12">
                            <?= Html::a('Создать', Url::to(['set-create']), ['class'=>'btn btn-primary']) ?>
                        </div>
                    </div>
                    <div class="row mb_3">
                        <div class="col-lg-12">
                            
                            <table class="table table-bordered sets-table">
                              <thead class="thead-dark">
                                <tr>
                                  <th class="col-lg-1"></th>
                                  <th scope="col"><?= $setsDataProvider->sort->link('name') ?></th>
                                  
                                  <th class="col-lg-1" scope="col"><?= $setsDataProvider->sort->link('active') ?></th>
...
$this->registerJs(
    ...
    $(".sets-table .remove").on("click", function (e) {
        e.preventDefault();
        ...
        if(confirm("Вы хотите удалить строку?")){
            $.ajax({
                ...
                $(".sets-table .row_"+remove_id).remove();
