    	...
    	<div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sx-8 col-sm-8">
                ...
                <div class="content">
                    ...
                    <!-- $roomsModel -->
                    <?php $form = ActiveForm::begin(['id' => 'rooms-create-form']); ?>

                    <?= $form->field($roomsModel, 'name')->textInput() ?>
                    
                    
                    <?= $form->field($roomsModel, 'image')->hiddenInput(['class'=>'uploadImageHiddenInput'])->label(false) ?>

                    <?= $form->field($roomsModel, 'about')->textarea(['rows' => '6'])  ?>
                    <?= $form->field($roomsModel, 'active')->checkbox(['label' => 'Показывать', 'labelOptions' => ['style' => 'padding-left:20px;'], 'checked' => 'checked']) ?>


                    <div class="form-group">
                        <div class="col-lg-6">
                            <?= Html::submitButton('Сохранить', ['class' => 'btn btn-primary', 'name' => 'rooms-button']) ?>
                        </div>
                        <div class="col-lg-6 text-right">
                            <?= Html::a('Отменить', 'rooms', ['class' => 'btn btn-danger', 'name' => 'rooms-button-cansel']) ?>
                        </div>
